...
#endif
#if CC_ENABLE_BOARD_TOOLS
extern cc_result_t cc_board_camera_tool_create(cc_tool_t *out_tool);
extern cc_result_t cc_board_audio_tool_create(cc_tool_t *out_tool);
extern cc_result_t cc_board_can_tool_create(cc_tool_t *out_tool);
extern cc_result_t cc_board_adc_tool_create(cc_tool_t *out_tool);
#endif
...
#if CC_ENABLE_BOARD_TOOLS
static cc_result_t create_board_camera_tool(const cc_runtime_tool_factory_ctx_t *ctx, cc_tool_t *out_tool)
{
    (void)ctx;
    return cc_board_camera_tool_create(out_tool);
}

static cc_result_t create_board_audio_tool(const cc_runtime_tool_factory_ctx_t *ctx, cc_tool_t *out_tool)
{
    (void)ctx;
    return cc_board_audio_tool_create(out_tool);
}

static cc_result_t create_board_can_tool(const cc_runtime_tool_factory_ctx_t *ctx, cc_tool_t *out_tool)
{
    (void)ctx;
    return cc_board_can_tool_create(out_tool);
}

static cc_result_t create_board_adc_tool(const cc_runtime_tool_factory_ctx_t *ctx, cc_tool_t *out_tool)
{
    (void)ctx;
    return cc_board_adc_tool_create(out_tool);
}
#endif
...
#endif
#if CC_ENABLE_BOARD_TOOLS
    {"board.camera", "camera", 1, create_board_camera_tool},
    {"board.audio", "audio", 1, create_board_audio_tool},
    {"board.can", "can", 1, create_board_can_tool},
    {"board.adc", "adc", 1, create_board_adc_tool},
#endif
